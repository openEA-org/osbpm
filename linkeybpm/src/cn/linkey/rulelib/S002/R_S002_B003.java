 ...
 *
 */
final public class R_S002_B003 implements LinkeyRule {
    @Override
    ...
    public void saveNode(String processid, String nodeid, String nodeType) {
        String qryNodeType = BeanCtx.g("QryNodeType", true); //url中指定的节点扩展类型
        String extNodeType = BeanCtx.g("ExtNodeType", true); //扩展类型
