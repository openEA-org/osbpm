 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-07-03 22:16
 */
final public class R_S010_E001 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) throws Exception {
        ...
        String sql = "select FolderName from BPM_NavTreeNode where Treeid='T_S010_001' and Folderid='" + doc.g("Folderid") + "'";
