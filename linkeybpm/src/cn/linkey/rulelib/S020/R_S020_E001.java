package cn.linkey.rulelib.S020;
 ...
 */
final public class R_S020_E001 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) throws Exception {
        ...
        String sql = "select FolderName from BPM_NavTreeNode where Treeid='T_S020_001' and Folderid='" + doc.g("Folderid") + "'";
