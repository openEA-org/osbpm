 ...
 */
final public class R_S007_B002 implements LinkeyRule {
    @Override
    ...
    public StringBuilder getAllSubFolder(Document doc, String async, String orgClass) {
        ...
        String fullDeptName = BeanCtx.getLinkeyUser().getFullDeptNameByDeptid(doc.g("Deptid"), false);
        StringBuilder jsonStr = new StringBuilder("{\"id\":\"" + doc.g("Folderid") + "\",\"Deptid\":\"" + doc.g("Deptid") + "\",\"FullDeptName\":\"" + fullDeptName + "\",\"text\":\"" + folderName
                + "\",\"OrgClass\":\"" + orgClass + "\"");
        //看此文件夹是否有子文件夹
