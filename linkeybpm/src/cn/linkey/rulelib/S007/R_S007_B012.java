...
/**
 * @RuleName:缺省职能部门选择树返回DeptName部门名称
 * @author admin
 * @version: 8.0
 * @Created: 2014-04-20 23:11
 */
final public class R_S007_B012 implements LinkeyRule {
    @Override
    ...
    public StringBuilder getAllSubFolder(Document doc, String async, String orgClass) {
        ...
        StringBuilder jsonStr = new StringBuilder("{\"id\":\"" + folderName + "\",\"text\":\"" + folderName + "\",\"OrgClass\":\"" + orgClass + "\"");
        //看此文件夹是否有子文件夹
