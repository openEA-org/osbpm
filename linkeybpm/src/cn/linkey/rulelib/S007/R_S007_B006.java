 ...
 */
final public class R_S007_B006 implements LinkeyRule {
    @Override
    ...
    public StringBuilder getAllSubFolder(Document doc, String async, String orgClass) {
        ...
        StringBuilder jsonStr = new StringBuilder("{\"id\":\"" + doc.g("Deptid") + "\",\"Deptid\":\"" + doc.g("Deptid") + "\",\"text\":\"" + folderName + "\",\"OrgClass\":\"" + orgClass + "\"");
        //看此文件夹是否有子文件夹
