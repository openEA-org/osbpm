package cn.linkey.rulelib.S019;
 ...
 */
final public class R_S019_E001 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) throws Exception {
        ...
        String sql = "select FolderName from BPM_NavTreeNode where Treeid='T_S019_001' and Folderid='" + doc.g("Folderid") + "'";
