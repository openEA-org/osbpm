 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-05-21 13:49
 */
final public class R_S015_E002 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) {
        ...
        if (doc.g("FolderType").equals("1")) {
            doc.s("iconCls", "icon-class");
        }
        if (doc.g("FolderType").equals("2")) {
            doc.s("iconCls", "icon-method");
        }
    }
