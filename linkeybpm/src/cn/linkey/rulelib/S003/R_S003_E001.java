 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-05-19 22:43
 */
final public class R_S003_E001 implements LinkeyRule {
    ...
    public String onFormOpen(Document doc, Document formDoc, String readOnly) {
        ...
        //		String processName="";
        //		String[] processidArray=Tools.split(doc.g("Processid"));
        //		for(String processid:processidArray){
        //		    if(Tools.isNotBlank(processName)){processName+=",";}
        //		    processName+=Rdb.getValueBySql("select NodeName from BPM_ModProcessList where Processid='"+processid+"'");
        //		}
        //		doc.s("Processid_show",processName);
