 ...
 *
 */
public class R_S003_B079 implements LinkeyRule {
    @Override
    public String run(HashMap<String, Object> params) throws Exception {
        ...
        if (Tools.isBlank(rearEventNodeid)) {
            ...
            if(linkeywf.getCurrentModNodeDoc()!=null){
            	loopType=linkeywf.getCurrentModNodeDoc().g("LoopType"); //循环类型
            }
        ...
        //3.前面程序都通过后推进到本outProcess节点后面的路由线,路由线后面如果接的是后置节点，则会反过来结束本节点
