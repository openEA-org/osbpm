 ...
 *
 */
public class R_S003_B060_bak implements LinkeyRule {
...
//					+ doc.g("WF_PROCESSID") + "' and NODEID='" + doc.g("NODEID") + "'";
//			if (currentInsUserDoc != null && Tools.isNotBlank(currentInsUserDoc.g("IsBackFlag"))
//					&& Integer.parseInt(currentInsUserDoc.g("IsBackFlag")) > 0 && "1".equals(Rdb.getValueBySql(sql2))) {
//				continue;
//			}
