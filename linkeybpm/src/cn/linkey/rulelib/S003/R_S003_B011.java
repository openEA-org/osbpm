 ...
 *
 */
public class R_S003_B011 implements LinkeyRule {
    ...
    public String run(HashMap<String, Object> params) throws Exception {
        ...
        mainFormBody = new StringBuilder(insHtmlParser.parserHtml(document, mainFormBody.toString(), true, readOnly, defaultReadType,uiType));
