 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-11-10 17:28
 */
final public class R_S016_E046 implements LinkeyRule {
    ...
    public String onViewOpen(Document viewDoc, String year, String processid) throws Exception {
        ...
        for (int i = 1; i <= 12; i++) {
            ...
            timesql = SqlType.createSql(DBType, "R_S016_E046_timesql", processid, starttime, endtime);
            numsql = SqlType.createSql(DBType, "R_S016_E046_numsql", processid, starttime, endtime);
            timesql1 = SqlType.createSql(DBType, "R_S016_E046_timesql1", processid, starttime1, endtime1);
            numsql1 = SqlType.createSql(DBType, "R_S016_E046_numsql1", processid, starttime1, endtime1);
