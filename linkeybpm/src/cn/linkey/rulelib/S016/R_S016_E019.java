 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-10-20 11:59
 */
final public class R_S016_E019 implements LinkeyRule {
    ...
    public String onViewOpen(Document viewDoc) throws Exception {
        ...
        String sql = "select Userid,count(*) as num from BPM_InsUserList group by Userid order by num asc";
        String countsql;
        String username = "[";
        String value = "[";
