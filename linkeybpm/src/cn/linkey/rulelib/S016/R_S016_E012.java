 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-10-20 09:56
 */
final public class R_S016_E012 implements LinkeyRule {
    ...
    public String onViewOpen(Document viewDoc) throws Exception {
        ...
        //String sql ="select top 10 processid,cast(avg(numb) as numeric(10,4)) as tmp from (SELECT processid,convert(int,DifTime) as numb FROM BPM_InsRemarkList ) as f group by processid order by tmp asc";
        //String countsql;
        //String processname="[";
        //String value="[";
    	...
    	String sql = SqlType.createSql(DBType, "R_S016_E012_SQL1");
