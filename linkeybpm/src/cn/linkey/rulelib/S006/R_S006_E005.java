 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-04-22 22:26
 */
final public class R_S006_E005 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) {
        ...
        String deptName = BeanCtx.getLinkeyUser().getDeptNameByUserid(doc.g("Userid"), false);
        doc.s("FolderName", deptName);
    }
