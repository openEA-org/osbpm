 ...
 */
final public class R_S006_B006 implements LinkeyRule {
    @Override
    ...
    public StringBuilder getUserItem(String orgClass, String folderid) {
        ...
        sql = "select count(*) as totalNum from BPM_OrgRoleMembersAll where RoleType='1' and OrgClass='" + orgClass + "' and Folderid='" + folderid + "'";
        ...
        sql = "select count(*) as totalNum from BPM_OrgRoleMembersAll where RoleType='2' and OrgClass='" + orgClass + "' and Folderid='" + folderid + "'";
        totalNum = Rdb.getValueBySql(sql);
