 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-04-24 11:10
 */
final public class R_S006_E013 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) {
        ...
        String sql = "select FolderName from BPM_OrgRoleTree where Treeid='2' and Folderid='" + doc.g("RoleFolderid") + "'";
