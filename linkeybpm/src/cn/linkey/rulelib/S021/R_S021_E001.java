package cn.linkey.rulelib.S021;
 ...
 */
final public class R_S021_E001 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) throws Exception {
        ...
        String sql = "select FolderName from BPM_NavTreeNode where Treeid='T_S021_001' and Folderid='" + doc.g("Folderid") + "'";
