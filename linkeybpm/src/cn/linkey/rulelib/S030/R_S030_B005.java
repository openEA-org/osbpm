 ...
 */
final public class R_S030_B005 implements LinkeyRule {
    @Override
    ...
    public String GetAllNodeList(String processid, String nodeid) {
        ...
        String sql = "select * from BPG_AllModNodeList where Processid='" + processid + "' and NodeType<>'Process' order by NodeType,NodeName";
