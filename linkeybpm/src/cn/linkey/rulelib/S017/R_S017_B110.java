...
/**
 * @RuleName:Rest_Engine转他人处理
 * @author  admin
 * @version: 8.0
 * @Created: 2017-09-08 08:38:10
 */
final public class R_S017_B110 implements LinkeyRule {
	@Override
	public String run(HashMap<String, Object> params) throws Exception  {
	    //params为运行本规则时所传入的参数
        String docUnid = BeanCtx.g("docUnid",true); //实例id
        String remark=BeanCtx.g("remark",true);
        String nextUserList=BeanCtx.g("nextUserList",true); //要转交的用户id多个用逗号分隔
        ...
        //提交工作流引擎运行
        String msg = linkeywf.run("GoToOthers", runParams);
        if (linkeywf.isDebug()) {
