...
/**
 * @RuleName:Rest_Engine返回给回退者
 * @author  admin
 * @version:1.0
 */
final public class R_S017_B118 implements LinkeyRule {
	@Override
	public String run(HashMap<String, Object> params) throws Exception  {
        ...
        //提交工作流引擎运行
        String msg = linkeywf.run("BackToReturnUser", runParams);
        if (linkeywf.isDebug()) {
            BeanCtx.out("Debug:" + msg);
        }

        //4.增加流转记录
        Remark remarkObj = (Remark) BeanCtx.getBean("Remark");
        remarkObj.AddRemark("BackToReturnUser", remark, "1");
