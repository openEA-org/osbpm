...
/**
 * @RuleName:Rest_Engine返回给转交者
 * @author  admin
 * @version: 1.0
 */
final public class R_S017_B117 implements LinkeyRule {
	@Override
	public String run(HashMap<String, Object> params) throws Exception  {
        ...
        //提交工作流引擎运行
        String msg = linkeywf.run("BackToDeliver", runParams);
        if (linkeywf.isDebug()) {
        ...
        remarkObj.AddRemark("BackToDeliver", remark, "1");
