 ...
 * @version: 1.0
 */
final public class R_S017_B181 implements LinkeyRule {
	@Override
	public String run(HashMap<String, Object> params) throws Exception  {
	    ...
	    String sql="select WF_DocNumber,Subject,WF_Author_CN,WF_AddName_CN,WF_DocCreated,WF_ProcessName,WF_CurrentNodeName,WF_OrUnid,WF_Folderid from BPM_MainData where "+sqlWhere;
	    sql+=" and WF_Status='Current' ";
