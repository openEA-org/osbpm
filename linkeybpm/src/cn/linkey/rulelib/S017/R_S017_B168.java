...
/**
 * @RuleName:Rest_TODO获取已阅流程
 * @author  admin
 * @version: 1.0
 */
final public class R_S017_B168 implements LinkeyRule {
	@Override
	public String run(HashMap<String, Object> params) throws Exception  {
	    ...
	    String tableName="BPM_AllReadDocument";
	    String sql="select WF_DocNumber,Subject,WF_Author_CN,WF_AddName_CN,WF_DocCreated,WF_ProcessName,WF_CurrentNodeName,WF_OrUnid from "+tableName+" where userid = '"+userId+"'";
