 ...
 */
final public class R_S008_B001 extends AppViewGrid implements LinkeyRule {
    @Override
...
//        } //以R_S008_B003中传入的优先
    ...
    public String getElementHtml(String gridNum) throws Exception {
        ...
        //增加一个portal的效果
        formBody.append("<div class=\"portlet box grey-cascade\" id=\"gridPortal\" ><div class=\"portlet-title\" >");
        ...
        formBody.append("</div></div><div id='win_view'></div>");
    ...
    public String getToolbar(Document gridDoc, boolean readOnly) {
        ...
        String searchHtml = "<span style=\"font-size:16px;\">" + BeanCtx.getMsg("Common", "Search") + ":</span>" + "<input class=\"easyui-searchbox\" data-options=\"searcher:GridDoSearch,prompt:'"
                + BeanCtx.getMsg("Common", "SearchPrompt") + "'\" id=\"SearchKeyWord\" style=\"width: 150px; height: 30px; line-height: 0px;\">";
