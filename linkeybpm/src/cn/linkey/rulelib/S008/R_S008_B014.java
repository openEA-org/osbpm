 ...
 *
 */
public class R_S008_B014 implements LinkeyRule {
    @Override
    public String run(HashMap<String, Object> params) throws Exception {
        StringBuilder formBody = new StringBuilder(3000);

        /* FormBody结束div */
        formBody.append("<!-- FormBody End-->\n");
        ...
        formBody.append("</div></div></form></div></div>");
    ...
    public StringBuilder getWorkflowHiddenField() throws Exception {
        ...
        tempStr.append("\n<script type=\"text/javascript\" src=\"linkey/bpm/jscode/engine_openform.js\"></script>\n");
        tempStr.append("<script type=\"text/javascript\" src=\"linkey/bpm/easyui/jquery.easyui.min.js\"></script>");
