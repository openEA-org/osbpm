package cn.linkey.rulelib.S022;
 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-07-04 10:59
 */
final public class R_S022_E001 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) throws Exception {
        ...
        String sql = "select FolderName from BPM_NavTreeNode where Treeid='T_S022_001' and Folderid='" + doc.g("Folderid") + "'";
