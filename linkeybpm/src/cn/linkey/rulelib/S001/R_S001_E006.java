 ...
 * 
 */
public class R_S001_E006 implements LinkeyRule {
	...
	public String onFormOpen(Document doc, Document formDoc, String readOnly) {
		...
		if (doc.isNewDoc()) {
			...
			String sql = "select GridNum from BPM_GridList where WF_Appid='" + appid
					+ "' and GridType='1' order by GridNum desc";
			String newGridNum = AppUtil.getElNewNum(sql);
			if (Tools.isBlank(newGridNum)) {
				newGridNum = "V_" + appid + "_G001";
			}
