 ...
 */
public class R_S001_E047 implements LinkeyRule {
    ...
    public String onFormSave(Document doc, Document formDoc) {
        ...
        doc.s("Singleton", "1");
        doc.s("Status", "1");
        doc.s("RuleType", "6"); //6表示过滤器规则
        doc.s("EventType", "0"); //0表示是规则
        doc.s("WF_Version", "8.0");
        String sql = "select DefaultCode from BPM_DevDefaultCode where CodeType='ChianRule_Code'";
