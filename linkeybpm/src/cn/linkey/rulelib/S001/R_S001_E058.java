 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-05-04 18:00
 */
final public class R_S001_E058 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) {
        ...
        //		BeanCtx.out("formtype="+doc.g("FormType"));
        String treeid = "T_S009_002";
        if (doc.g("FormType").equals("2")) {
            treeid = "T_S009_001";
        }
        String sql = "select FolderName from BPM_NavTreeNode where Treeid='" + treeid + "' and Folderid='" + folderid + "'";
        //		BeanCtx.out(sql);
