...
/**
 * 本规则为copy custom grid 视图事件
 * 
 * @author Administrator
 * 
 */
public class R_S001_E034 implements LinkeyRule {
    ...
    public String onDocCopy(Document doc, Document gridDoc) {
        ...
        String sql = "select GridNum from BPM_GridList where WF_Appid='" + appid + "' and GridType='5' order by GridNum desc";
        ...
        String gridBody = doc.g("GridBody");
        gridBody = gridBody.replace("&lt;", "<").replace("&gt;", ">").replace("&amp;", "&");
        doc.s("GridBody", gridBody);
