 ...
 * 
 */
public class R_S001_E002 implements LinkeyRule {
    ...
    public String onDocCopy(Document doc, Document gridDoc) {
        ...
        String sql = "select FormNumber from BPM_FormList where WF_Appid='" + appid + "' and FormType='1' order by FormNumber desc";
