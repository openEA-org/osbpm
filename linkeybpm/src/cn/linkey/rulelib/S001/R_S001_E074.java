 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-11-18 22:01
 */
final public class R_S001_E074 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) throws Exception {
        ...
        String sql = "select * from BPM_AllElementList where WF_OrUnid='" + doc.g("wf_eldocunid") + "'";
        Document gdoc = Rdb.getDocumentBySql(sql);
        doc.s("ElementNum", gdoc.g("eleid"));
        doc.s("ElementName", gdoc.g("eleName"));
    }
