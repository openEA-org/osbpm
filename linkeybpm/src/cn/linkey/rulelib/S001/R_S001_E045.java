 ...
 */
public class R_S001_E045 implements LinkeyRule {
    ...
    public String onFormOpen(Document doc, Document formDoc, String readOnly) {
        ...
        if (doc.isNewDoc()) {
            ...
            String sql = "select RuleNum from BPM_RuleList where WF_Appid='" + appid + "' and RuleType='4' order by RuleNum desc";
            String newRuleNum = AppUtil.getElNewNum(sql);
            if (Tools.isBlank(newRuleNum)) {
                newRuleNum = "R_" + appid + "_F001";
            }
