...
/**
 * @RuleName:格式化Grid列表的URL
 * @author admin
 * @version: 8.0
 * @Created: 2014-04-11 11:19
 */
public class R_S001_E051 implements LinkeyRule {
    @Override
    ...
    public void formatRowData(Document doc) {
        ...
        String gridType = doc.g("GridType");
        String action = "view";
        if (gridType.equals("3")) {
            action = "treegrid";
        }
        ...
        doc.s("GridNum", action + "?wf_num=" + doc.g("GridNum"));
    }
