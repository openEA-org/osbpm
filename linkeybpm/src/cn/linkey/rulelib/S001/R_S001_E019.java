...
/**
 * 本规则为copy editor grid 视图事件
 * 
 * @author Administrator
 * 
 */
public class R_S001_E019 implements LinkeyRule {
    ...
    public String onDocCopy(Document doc, Document gridDoc) {
        ...
        String sql = "select GridNum from BPM_GridList where WF_Appid='" + appid + "' and GridType='2' order by GridNum desc";
