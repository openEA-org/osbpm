...
/**
 * 本规则为copy tree grid 视图事件
 * 
 * @author Administrator
 * 
 */
public class R_S001_E028 implements LinkeyRule {
    ...
    public String onDocCopy(Document doc, Document gridDoc) {
        ...
        String sql = "select GridNum from BPM_GridList where WF_Appid='" + appid + "' and GridType='4' order by GridNum desc";
