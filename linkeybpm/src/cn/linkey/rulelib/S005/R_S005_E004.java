 ...
 * @author admin
 * @version: 8.0
 * @Created: 2014-05-16 13:16
 */
final public class R_S005_E004 implements LinkeyRule {
    ...
    public String onFormOpen(Document doc, Document formDoc, String readOnly) {
        ...
        Document userdoc = Rdb.getDocumentBySql("select * from BPM_UserProfile where Userid='" + BeanCtx.getUserid() + "'");
        doc.s("Userid", BeanCtx.getUserName());
        doc.s("LastLoginTime", userdoc.g("LastLoginTime"));
        doc.s("LastPasswordTime", userdoc.g("LastPasswordTime"));
        doc.s("LastLoginIP", userdoc.g("LastLoginIP"));
