 ...
 */
public class AppForm_bak implements AppElement {
    ...
    public String getElementHtml(String formNumber) throws Exception {
        ...
        if (Tools.isBlank(jsHeader)) {
            jsHeader = Rdb.getValueBySql("Select DefaultCode from BPM_DevDefaultCode where CodeType='layui_Form_JsHeader'");
        }
        else {
    ...
    public String getToolbar(Document dataDoc, String toolbarJson, boolean readOnly, boolean isNewDoc) {
        if (Tools.isBlank(toolbarJson)) {
            toolbarJson = Rdb.getValueBySql("select DefaultCode from BPM_DevDefaultCode where CodeType='layui_Form_Toolbar'");
        }
                ...
                if (linkeyUser.inRoles(BeanCtx.getUserid(), roleNumber)) {
                    ...
                    if (Tools.isBlank(hiddenfd) || dataDoc.g(hiddenfd).equals("true")) {
                        ...
                        toolbarHtml.append("<button id=\"" + toolbarItem.getString("btnid") + "\" class=\""
								+ btnClass + "\" "+ btnFilter + btntype +" onclick=\"" + toolbarItem.getString("clickEvent") + "\">" + btnName
								+ "</button>");
                    }
                }
            }
