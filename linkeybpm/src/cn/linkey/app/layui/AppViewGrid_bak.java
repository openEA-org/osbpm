 ...
 *        Alibao v1.0.0 修改原因
 */
public class AppViewGrid_bak implements AppElement {

	String groudBtn = "0"; // 按钮组判断
				...
				if (linkeyUser.inRoles(BeanCtx.getUserid(), roleNumber)) {
					...
					if (Tools.isBlank(hiddenfd) || gridDoc.g(hiddenfd).equals("true")) {
						...
						toolbarHtml.append("<button id=\"" + toolbarItem.getString("btnid") + "\" class=\""
								+ btnClass + "\" onclick=\"" + toolbarItem.getString("clickEvent") + "\">" + btnName
								+ "</button>");
					}
				}
			}
...
//						isToolBarFlag = true;
//						String btnName = toolbarItem.getString("btnName");
//						String btnClass = toolbarItem.getString("btnclass");
//						if (btnName.startsWith("L_")) {
//							btnName = BeanCtx.getLabel(btnName);
//						}
//						/*
//						 * toolbarHtml.append("| <a href=\"#\" id=\"" +
//						 * toolbarItem.getString("btnid") +
//						 * "\" class=\"easyui-linkbutton\" plain=\"true\" data-options=\"iconCls:'"
//						 * + toolbarItem.getString("iconCls") + "'\" onclick=\""
//						 * + toolbarItem.getString("clickEvent") +
//						 * ";return false;\">" + btnName + "</a>");
//						 */
//						toolbarHtml.append("<button id=\"" + toolbarItem.getString("btnid") + "\" class=\"layui-btn "
//								+ btnClass + "\" onclick=\"" + toolbarItem.getString("clickEvent") + "\">" + btnName
//								+ "</button>");
//					}
//				}
