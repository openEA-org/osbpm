...
if((tt.children("span").hasClass("tree-hit")) || tt.hasClass("tree-hit") || tt.hasClass("tree-title") && tt.siblings("span").hasClass("tree-hit") || tt.hasClass("tree-indent") && tt.siblings("span").hasClass("tree-hit") || tt.hasClass("tree-icon") && tt.siblings("span").hasClass("tree-hit")){
//if(tt.hasClass("tree-hit")){
_121(_b8,_bc[0]);
return false;
}else{
...
var _117=$(ul).prev().children("span.icon-folder");
_117.addClass("fa fa-lgr fa-pulse fa-spinne ");
//edit end
var _118=opts.loader.call(_113,_114,function(data){
//edit
//_117.removeClass("tree-loading");
_117.removeClass("fa fa-lgr fa-pulse fa-spinne ");
//edit end
_fe(_113,ul,data);
if(_115){
_115();
...
hit.removeClass("tree-collapsed tree-collapsed-hover fa-chevron-right").addClass("tree-expanded fa-chevron-down");
//edit end
//edit
//hit.next().addClass("tree-folder-open");
var temp_class = hit.next().attr("class");
hit.next().attr("backup", temp_class); //备份样式
temp_class = "tree-icon icon-folder-open";
hit.next().attr("class", temp_class); //将临时样式设置上去
//edit end
var ul=$(_11b).next();
if(ul.length){
if(opts.animate){
...
hit.removeClass("tree-expanded tree-expanded-hover fa-chevron-down").addClass("tree-collapsed fa-chevron-right");
//edit end
//edit
//hit.next().removeClass("tree-folder-open");
var temp_backupclass = hit.next().attr("backup");
hit.next().removeAttr("backup");
hit.next().attr("class", temp_backupclass);
//edit end
var ul=$(_120).next();
if(opts.animate){
...
if (_137.hasClass("icon-file")){
_137.removeClass("icon-file").addClass("icon-folder");
}
var temp_class = _137.attr("class");
_137.attr("backup", temp_class); //备份样式
temp_class += "tree-icon icon-folder-open";
_137.attr("class", temp_class); //将临时样式设置上去
//edit end
//edit2
//var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_137);
var hit=$("<span class=\"tree-hit tree-expanded fa fa-chevron-down\"></span>").insertBefore(_137);
//end edit2
if(hit.prev().length){
hit.prev().remove();
}
...
if (node.find(".tree-icon").hasClass("icon-folder"))
node.find(".tree-icon").removeClass("icon-folder").addClass("icon-file");
//edit end
...
var target = $(_166).find("div.tree-node-selected");
target.children("#arrow-right").remove();
target.removeClass("tree-node-selected");
$(_167).addClass("tree-node-selected");
$(_167).css("background-image", "none");
$(_167).css("position", "relative");
$(_167).append("<i id=\"arrow-right\" class=\"fa fa-chevron-right\" style=\"left: 87%;top: 40%;position: absolute;color: " + $(_167).children(".tree-title").css("color") + ";\"></i>");
//end edit
...
$(ul).append(cc.join(""));
//edit2=================================================
$("span.tree-hit").css("color", $("span.tree-icon:first").css("color")).css("background", "none");
//edit end
...
cc.push("<span class=\"tree-hit tree-collapsed fa fa-chevron-right\"></span>");
//end edit
//edit
//cc.push("<span class=\"tree-icon tree-folder "+(item.iconCls?item.iconCls:"")+"\"></span>");
cc.push("<span class=\"tree-icon "+(item.iconCls?item.iconCls:"icon-folder")+"\"></span>");
//edit end
}else{
if(item.children&&item.children.length){
//edit2
//cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"tree-hit tree-expanded fa fa-chevron-down\"></span>");
//edit end
//edit
//cc.push("<span class=\"tree-icon tree-folder tree-folder-open "+(item.iconCls?item.iconCls:"")+"\"></span>");
cc.push("<span class=\"tree-icon icon-folder-open\" backup=\"tree-icon " + (item.iconCls?item.iconCls:"icon-folder") + "\"></span>");
//edit end
}else{
cc.push("<span class=\"tree-indent\"></span>");
//edit
//cc.push("<span class=\"tree-icon tree-file "+(item.iconCls?item.iconCls:"")+"\"></span>");
cc.push("<span class=\"tree-icon "+(item.iconCls?item.iconCls:"icon-file")+"\"></span>");
//edit end
}
}
if(opts.checkbox){
...
var _761=body.find("tr[node-id=\""+_75c+"\"] span.icon-folder");
_761.addClass("fa fa-lgr fa-pulse fa-spinne");
//edit end
$(_75b).treegrid("loading");
var _762=opts.loader.call(_75b,_760,function(data){
//edit
//_761.removeClass("tree-loading");
_761.removeClass("fa fa-lgr fa-pulse fa-spinne");
//edit end
...
if (_795.hasClass("icon-file")){
_795.removeClass("icon-file").addClass("icon-folder");
var temp_class = _795.attr("class");
_795.attr("backup", temp_class); //备份样式
temp_class += "tree-icon icon-folder-open";
_795.attr("class", temp_class); //将临时样式设置上去
//edit end
//edit2
//var hit=$("<span class=\"tree-hit tree-expanded\"></span>").insertBefore(_795);
var hit=$("<span class=\"tree-hit tree-expanded fa fa-chevron-down\"></span>").insertBefore(_795);
//edit end
if(hit.prev().length){
hit.prev().remove();
}
...
if (cell.hasClass("icon-folder"))
cell.find(".tree-icon").removeClass("icon-folder").addClass("icon-file");
//edit end
...
tr.find("span.tree-hit").removeClass("tree-expanded tree-expanded-hover fa-chevron-down").addClass("tree-collapsed fa-chevron-right");
//edit end
_77f(this,_7aa.id);
}else{
_73c(this,null,_7aa);
...
cc.push("<span class=\"tree-icon "+(row.iconCls?row.iconCls:"icon-folder")+"\"></span>");
//edit end
}else{
if(row.children&&row.children.length){
//edit2
...
cc.push("<span class=\"tree-icon icon-folder-open\" backup=\"tree-icon " + (row.iconCls?row.iconCls:"icon-folder") + "\"></span>");
//edit end
}else{
cc.push("<span class=\"tree-indent\"></span>");
//edit
//cc.push("<span class=\"tree-icon tree-file "+(row.iconCls?row.iconCls:"")+"\"></span>");
cc.push("<span class=\"tree-icon "+(row.iconCls?row.iconCls:"icon-file")+"\"></span>");
//edit end
}
}
...
var target = tree.find("div.tree-node-selected");
target.children("#arrow-right").remove();
target.removeClass("tree-node-selected");
//end edit
...
_8de(this,q);
}},currentText:"今天",closeText:"关闭",okText:"确认",buttons:[{text:function(_8ef){
