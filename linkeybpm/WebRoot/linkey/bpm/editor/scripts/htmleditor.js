...
function doClick_TabCreate()
	...
	var sHTML="<table style='border-collapse:collapse;width:100%;' class='linkeytable'>";
...
function showContextmenu(strName)
	...
	if(tagName=="input" || tagName=="select" || tagName=="textarea" )
	{
		...
		var pHTML="<TABLE width=100% border=0 margin='0px' cellSpacing=1 cellpadding=4 >";
		pHTML+="<TR><TD height=1 bgcolor=cccccc ></td></tr>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"[F]附件$1[/F]\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入附件上载框</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"[C][/C]\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入共享代码标签</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"[X]计算文本[/X]\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入计算文本标签</TD></TR>";
        pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"[T]意见类型[/T]\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入意见显示标签</TD></TR>";
		pHTML+="</TABLE>";
		oPopDocument.write(pHTML);
		oPopDocument.close();
