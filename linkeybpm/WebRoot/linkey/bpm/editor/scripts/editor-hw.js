...
function showContextmenu(strName)
	{
		...
		var y=oEditor.event.clientY+100;
		var menu = new top.Ext.menu.Menu({
          id: 'Compose',
          items: [
            new top.Ext.menu.Item({
                text: '修改文件夹',
                handler: function(){}
            }),
            new top.Ext.menu.Item({
...
*/
	...
	if(tagName=="input" || tagName=="select" || tagName=="textarea" )
	{
		...
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px;padding-top:5px'  onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn184.gif' align=absmiddel >字段名："+fdName+"</TD></TR>";
		pHTML+="<TR><TD height=1 bgcolor=cccccc ></td></tr>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddNewField(\""+fdName+"\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >加入到字段列表中</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.SetNotNull(\""+fdName+"\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >不允许为空</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.SetDicData(\""+fdName+"\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >匹配数据字典</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.FocusFieldRow(\""+fdName+"\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >切换至字段属性</TD></TR>";
		...
		var h=150;//oPopDocument.body.scrollHeight;
		...
		var pHTML="<TABLE width=100% border=0 margin='0px' cellSpacing=1 cellpadding=4 >";
		pHTML+="<TR><TD height=1 bgcolor=cccccc ></td></tr>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"<span class=redstar>*</span>\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入不为空*号</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"[F]File_1_1[/F]\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入附件上载框</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"[C]Bottom[/C]\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入Bottom代码</TD></TR>";
		pHTML+="<TR><TD align='left' style='cursor:default;height:22px' onclick='parent.parent.AddBlankStr(\"[X]计算文本[/X]\");' onmouseover='this.style.background=\"#f1f194\"' onmouseout='this.style.background=\"#d2d8ea\"'><img src='/icons/vwicn104.gif' align=absmiddel >插入计算文本</TD></TR>";
		pHTML+="</TABLE>";
		oPopDocument.write(pHTML);
		oPopDocument.close();
...
function AddNewField(FdName)
{
	...
	for(i=0;i<rc.length;i++)
	{
		...
		{
			alert("字段已经在列表中");return false;	
		}
	}

 var p = new top.Plant({FdName: FdName,FdInfo: FdName,FdMsg:"",FdType:"TEXT",FdBlank:"",FdCheck:"",FdValue:"",FdAction:"",FdFun:""});
