...
<% if(!eldoc.g("EventType").equals("0")){%>
<tr><td valign="middle" width="21%" align="right">事件类型:</td>
<td width="79%">
<select name="EventType" id="EventType"  >
<%
	String eventType=eldoc.g("EventType");
	if(eventType.equals("1")){checkStr="selected";}else{checkStr="";}
	out.println("<option value=\"1\" "+checkStr+" >表单事件</option>");
	
	if(eventType.equals("2")){checkStr="selected";}else{checkStr="";}
	out.println("<option value=\"2\" "+checkStr+" >视图事件</option>");
	
	if(eventType.equals("3")){checkStr="selected";}else{checkStr="";}
	out.println("<option value=\"3\" "+checkStr+" >数据源事件</option>");

	if(eventType.equals("4")){checkStr="selected";}else{checkStr="";}
	out.println("<option value=\"4\" "+checkStr+" >页面事件</option>");
