...
<% 	if(eldoc.g("autoHeight").equals("1")){checked="checked";}else{checked="";} %>
<input class="lschk" name="autoHeight" value="1" <%=checked%> type="checkbox"/>自动行高

<% 	if(eldoc.g("striped").equals("1")){checked="checked";}else{checked="";} %>
<input class="lschk" name="striped" value="1" <%=checked%> type="checkbox"/>交叉行
