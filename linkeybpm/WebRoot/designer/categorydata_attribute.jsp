...
function PreviewView(){
	...
	window.open("../categorydata?wf_num="+$("#Dataid").val());
}
...
<div id="eventwin"></div>
<% if(Tools.isNotBlank(BeanCtx.g("fromview"))){%>
...
<tr><td valign="middle" width="21%" align="right">指定要对数据进行分类的字段:</td>
<td width="79%">
<input value="<%=eldoc.g("CategoryField")%>" name="CategoryField" id="CategoryField" class="easyui-validatebox" required title="多个字段请用逗号分隔"  size="60"/>
</td>
</tr>
...
<% if(eldoc.g("ExtXmlData").equals("1")){checked="checked";}else{checked="";} %>
<input value="1" name="ExtXmlData" type="checkbox" <%=checked%> />展开XmlData
