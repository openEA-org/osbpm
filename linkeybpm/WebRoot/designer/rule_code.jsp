...
<td width='*' valign=top >
        	...
        	<iframe src="../linkey/bpm/editor/ace/editor.html?mode=java&frmname=HTMLFRAEM_RuleCode&fdname=RuleCode" frameborder=0 width=100% height="100%" name="HTMLFRAEM_RuleCode" id="HTMLFRAEM_RuleCode" ></iframe>
			</form>
</td>
</tr></table>
