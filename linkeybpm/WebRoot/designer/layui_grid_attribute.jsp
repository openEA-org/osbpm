...
function serializeForm(){
	...
	formData="WF_TableName=BPM_GridList&GridType=1&"+formData;
	return formData;
}
...
function PreviewView(){
	window.open("../view?wf_num=<%=gridNum%>");
}
...
<td width="79%"><input value="<%=eldoc.g("NewFormNum")%>" name="NewFormNum" id="NewFormNum" size="60" class="easyui-combobox" data-options="
                    ...
                    textField:'FormName',
                    groupField:'WF_Appid',
                    formatter:function(r){return r.FormName+'('+r.FormNumber+')';}
            " /> 
...
<%
	...
	String pageList=Tools.isBlank(eldoc.g("PageList")) ? "[25,30,45,60,100,200]" : eldoc.g("PageList");
%>
<td width="79%">
...
<%-- <tr><td width="21%" align="right">接收JSON格式:</td>
<%
String setJSONFormat=eldoc.g("setJSONFormat");
if(Tools.isBlank(setJSONFormat)){setJSONFormat="countName: 'total',dataName: 'rows'";}
%>
<td width="79%"><input value="<%=setJSONFormat%>" name="setJSONFormat" size="60" title="默认为:countName: 'total',dataName: 'rows'" class="easyui-validatebox" /></td>
</tr> --%>

<tr><td>默认传入数据源参数:</td><td>
<input value="<%=eldoc.g("DataSourceParams")%>" name="DataSourceParams" class="easyui-validatebox" validType='DataSourceParams'  title="格式为:token: 'sasasas', id: 123" size="60"  />
</td></tr>
