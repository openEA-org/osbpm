...
%>
<!DOCTYPE html><html><head><title>layui Form Attribute</title>
...
<div class="easyui-layout" id="panel" fit="true" style="width:100%;">
    ...
    <div data-options="region:'west',split:true" style="width:150px;">
        <div class="easyui-accordion" data-options="fit:true,border:false">
            <div title="基础控件" data-options="selected:true" style="padding:5px;"><%=appFormDesigner.getFormControlHtmlCode("1",uiType)%>
            </div>

            <div title="流程相关控件" style="padding:5px;"><%=appFormDesigner.getFormControlHtmlCode("2",uiType)%>
            </div>

            <div title="自定义控件" style="padding:5px"><%=appFormDesigner.getFormControlHtmlCode("3",uiType)%>
            </div>
    ...
    <div region="center" border="true" fit="false">
        <div class="easyui-layout" id="centerpanel" fit="true" style="width:100%;">
            ...
            <div data-options="region:'south',split:true" style="height:60px;overflow:hidden">
                ...
                <a href="#" onclick="editEditorHtml();return false;" title="Change html">
                    <img src="../linkey/bpm/images/icons/sok.gif" border="0">
                </a>
            </div>
        </div>
    </div>
