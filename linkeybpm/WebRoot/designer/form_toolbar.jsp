...
<script>
 function formonload(){}
function insertRow(){
	$('#dg').datagrid('appendRow',{"btnid":"btnNew","btnName":"Button Name","clickEvent":"SaveDocument()","hidden":"","icons":"cmp.gif","sortNum":"5"});
}
...
if(jsonStr==""){
		...
		{"btnid":"btnQuit","btnName":"保存退出","clickEvent":"SaveDocument('Quit')","hidden":"READ","iconCls":"icon-save","sortNum":"1"},
		{"btnid":"btnSave","btnName":"保存","clickEvent":"SaveDocument()","hidden":"READ","iconCls":"icon-save","sortNum":"2"},
		{"btnid":"btnEdit","btnName":"编辑","clickEvent":"EditDocument()","hidden":"NEW,EDIT,NOAUTHOR","iconCls":"icon-edit","sortNum":"3"},
		{"btnid":"btnBack","btnName":"返回","clickEvent":"history.back()","hidden":"","iconCls":"icon-back","sortNum":"4"}
	]}
}else{
 ...
 <table id="dg" width="100%" height="300px" class="easyui-datagrid" data-options="data:btnJson,remoteSort:false,singleSelect:false,border:false,fitColumns:true,rownumbers: true,onClickRow: editRow,onRowContextMenu:stopEditRow">
     <thead>
         <tr>
            ...
            <th width="100"  data-options="field:'RoleNumber',width:100,
                        editor:{
                            type:'combobox',
                            options:{
