...
function NewEventForm(){
	$('#eventwin').window({ width:600,height:320,modal:true,title:'新增事件'});
    $('#eventwin').html("<iframe height='300px' width='100%' frameborder='0' src='../form?wf_num=F_S001_A013&wf_treeid=T_S009_001'></iframe>");
}
...
<input value="<%=formDoc.g("Folderid")%>" name="Folderid" id="Folderid"  size="60" class="easyui-combotree" data-options="
                    ...
                    valueField:'id',
                    textField:'text'
            "  /> <a href="#" class="easyui-linkbutton"   onclick="NewEventForm();return false;">新建</a>
</td>
</tr>
