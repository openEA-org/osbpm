...
<tr><td valign="middle" width="21%" align="right">过滤顺序:</td>
<%
	String sortNum=eldoc.g("SortNum");
	if(Tools.isBlank(sortNum)){
		sortNum="1021";
	}
%>
<td width="79%"><input value="<%=sortNum%>" name="SortNum" id="SortNum"  class="easyui-validatebox" required size="20"/></td>
</tr>

<tr><td valign="middle" width="21%" align="right">过滤范围:</td>
<td width="79%">
<select name="ChianAppid" id="ChianAppid"  class="easyui-combobox" multiple="true" style="width:390px" >
<option value="*" >-默认为所有应用-</option>
<%
	Document[] rc=Rdb.getAllDocumentsBySql("select * from BPM_AppList");
	for(Document appdoc:rc){
		String selectStr="";
		if(appdoc.g("WF_Appid").equals(eldoc.g("ChianAppid"))){
			selectStr="selected";
		}
