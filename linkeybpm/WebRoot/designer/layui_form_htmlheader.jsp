...
String appFormHtmlHeader="layui_AppFormHtmlHeader";
if(Tools.isBlank(docunid)){
	...
	String formType = formDoc.g("FormType");
	if(formDoc.isNull()){
		...
		if(Tools.isBlank(appFormHtmlHeader)){
			if(formType.equals("1")){
				appFormHtmlHeader="layui_AppFormHtmlHeader";
			}else{
				appFormHtmlHeader="layui_ProcessFormHtmlHeader";
			}
		}
	}
}
