...
function updateCustom(){
 ...
 $('#win').html("<iframe height='450px' width='100%' overflow='hidden' frameborder='0' src='../r?wf_num=V_S001_E021&notCodeType=1'></iframe>");
}
...
<iframe src="../linkey/bpm/editor/ace/editor.html?mode=javascript&frmname=HTMLFRAEM_JsHeader&fdname=JsHeader&theme=<%= themeid %>" frameborder=0 width=99.5% height="600px" name="HTMLFRAEM_JsHeader" id="HTMLFRAEM_JsHeader" ></iframe>
