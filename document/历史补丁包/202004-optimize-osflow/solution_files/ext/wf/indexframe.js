...
Ext.onReady(function() {
    ...
    tb.add('-', {
        ...
        text: '保存为图片',
        handler: function() {
            // 202003 add by alibao 添加图片尺寸处理 =====start
            // location.href = "r?wf_num=R_S002_B022&Processid=" + processid;

            flowframe.lkwf.savePicture();
            // 202003 add by alibao 添加图片尺寸处理 =====end
        }
    }, '-', {
        cls: 'x-btn-text-icon bmenu',
        ...
        cls: 'x-btn-text-icon bmenu',
        icon: 'linkey/bpm/ext/wf/images/convergeLine.jpg',
        text: '汇聚',
        handler: function() {
            flowframe.lkwf.convergeLine();
        }
    }, {
        cls: 'x-btn-text-icon bmenu',
        icon: 'linkey/bpm/ext/wf/images/convergeLine.jpg',
    ...
    imgtb.add('-', {
        ...
        //20190919 放大缩小   add by lcd --start
        // {
        //     cls: 'x-btn-text-icon bmenu',
        //     icon: 'linkey/bpm/ext/wf/images/fd.gif',
        //     text: '放大',
        //     handler: function() {
        //         flowframe.Increase();
        //     }
        // }, {
        //     cls: 'x-btn-text-icon bmenu',
        //     icon: 'linkey/bpm/ext/wf/images/sx.gif',
        //     text: '缩小',
        //     handler: function() {
        //         flowframe.Narrow();
        //     }
        // },
        //20190919 放大缩小   add by lcd --end
        {
            cls: 'x-btn-text-icon bmenu',
            ...
            cls: 'x-btn-text-icon bmenu',
            icon: 'linkey/bpm/ext/wf/images/input.gif',
            text: '智能折线',
            handler: function() {
                flowframe.mySetType('PolyLine', 'innerLine');
            }
        }, {
            cls: 'x-btn-text-icon bmenu',
